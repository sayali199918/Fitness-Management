...
%>
	...
	<div
		...
		<form action="admin-login-action" method="post" class="" style="width: 50%">

			<c:if test="${param.q == 0 }">
				<div class="alert alert-danger">Application Error</div>
			</c:if>
    ...
    <i class="fa fa-key icon"></i>
			...
			<div class="mt-1">
				<a href="home.jsp"><input class="btn btn-secondary btn-block" type="button"
					value="Cancel"></a>
			</div>

			<div class="mt-1 d-flex justify-content-center text-primary">
				<a href="AdminRegister.jsp" class="btn btn-link">Register Here...</a>
			</div>
		</form>
	</div>
